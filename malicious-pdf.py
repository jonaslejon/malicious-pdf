...
# -*- coding: UTF-8 -*-
##
## Generate 54 malicious PDF files with phone-home functionality
...
# PortSwigger Research: Hybrid Acrobat/Chrome payload removed
# test27 was split into test27_1 (Acrobat OpenAction JS) and test27_2 (Chrome Widget Btn)
# but both are duplicates of test3 and test23 respectively, so test27 is removed entirely.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate 54 malicious PDF files with phone-home functionality for penetration testing. "
    ...
    pdf_generators = {
        ...
        # test27 removed - was hybrid Acrobat/Chrome, duplicates test3 + test23

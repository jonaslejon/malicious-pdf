...
def validate_url_or_ip_validators(input_string: str) -> bool:
...
def create_malpdf11(filename: str) -> None:
...
def create_malpdf10(filename: str) -> None:
...
def create_malpdf9(filename: str, host: str) -> None:
    with open(filename, "w") as file:
        file.write('''%PDF-1.7
